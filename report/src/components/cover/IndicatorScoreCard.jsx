  ...
  return (
    <div className="indicator-score-card">
      <div className="indicator-score-card-header">
        ...
        <span className="indicator-badge" style={{ background: badgeColor }}>{indicador.score}</span>
      </div>
      <div className="indicator-score-card-footer">Score com base na Meta nacional</div>
    </div>
  );
}
