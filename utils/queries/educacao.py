...
# O perfil educacional (texto/prosa) não mora mais aqui: vem de
# `utils.queries.perfil_municipal.buscar_perfil_municipal`, o mesmo caminho dos
# outros macrotemas (SELECT * em relatorios_auto.mv_perfil_educacional_municipal).
# Havia uma lista fixa de colunas neste arquivo que ficou desatualizada em
# relação à view e fazia `$tend_ens_sup` sair cru no relatório; com SELECT *,
# coluna nova da view chega sozinha ao contexto.
